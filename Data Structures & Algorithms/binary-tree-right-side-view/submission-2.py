...
"""
Lesson:
- For BFS always append the root in queue first.
- 2^H is the node at H-th level.
- The last level contains N+1/2 nodes.
"""
...
# Time: O(N)
# Space: O(N) for the N/2 nodes of the last level