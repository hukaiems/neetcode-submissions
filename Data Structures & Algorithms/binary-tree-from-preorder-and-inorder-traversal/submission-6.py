...
Solution:
    ...
    2. Use recursive DFS with hash map and pointers
        - Hash map val:idx base on inorder so we can find in O(1).
        - Use 2 pointers to keep everything in bound using index from inorder
            Without taking anything in those pointers, no value...
"""
