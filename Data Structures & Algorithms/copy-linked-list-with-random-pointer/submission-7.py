...
class Solution:
    def copyRandomList(self, head: 'Optional[Node]') -> 'Optional[Node]':
        ...
        # we can use the hash map to connect easily and handle the Null case too. 
        # Every node are copied inside hash map so we can use hash map to connect every existed node.
